...
const button_style_1 = zltk.Button.Style{ .background = .{ .r = 0x21, .g = 0x96, .b = 0xf3 }, .active_background = .{ .r = 0x19, .g = 0x76, .b = 0xd2 }, .foreground = .{ .r = 255, .g = 255, .b = 255 }, .font = "6x13" };

const button_style_2 = zltk.Button.Style{ .background = .{ .r = 0xff, .g = 0xeb, .b = 0x3b }, .active_background = .{ .r = 0xfb, .g = 0xc0, .b = 0x2d }, .foreground = .{ .r = 0x11, .g = 0x11, .b = 0x11 }, .font = "6x13" };
